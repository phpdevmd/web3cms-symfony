<?php $view['stylesheets']->add('bundles/app/css/main.css') ?>
<?php $view['stylesheets']->add('bundles/app/css/960.css') ?>
<?php $view['stylesheets']->add('bundles/3rdparty/css/jqueryui/start/jquery-ui-1.8.6.custom.css') ?>
<?php if(file_exists(__DIR__.'/../../web/bundles/app/css/ui.css') && filesize(__DIR__.'/../../web/bundles/app/css/ui.css')!==0): ?>
<?php $view['stylesheets']->add('bundles/app/css/ui.css') ?>
<?php endif ?>
...
<link rel="shortcut icon" href="<?php echo $view['assets']->getUrl('bundles/app/images/favicon.ico') ?>" type="image/x-icon" />
...
if (typeof jQuery == 'undefined') {
    document.write('<script type="text/javascript" src="<?php echo $view['assets']->getUrl('bundles/3rdparty/js/jquery/jquery-1.4.3.min.js') ?>"><\/script>');
}
if (typeof jQuery.ui == 'undefined') {
    document.write('<script type="text/javascript" src="<?php echo $view['assets']->getUrl('bundles/3rdparty/js/jqueryui/jquery-ui-1.8.6.custom.min.js') ?>"><\/script>');
}
/*]]>*/
</script>
<title>
